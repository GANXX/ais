...
# 加载预训练模型
base_model = AutoModelForCausalLM.from_pretrained('/home/aiservice/workspace/data/questionBData/model/%s'%(MODEL_PATH), quantization_config=bnb_config, device_map="auto",torch_dtype=torch.bfloat16)
...
args = TrainingArguments(
    output_dir="/home/aiservice/workspace/questionB/output/%s/%s"%(MODEL, DATA_SET),
...
lora_path='/home/aiservice/workspace/questionB/saved_model/%s'%(DATA_SET)
